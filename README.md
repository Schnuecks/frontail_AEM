...
Thanks to the work of [Ethan Dye](https://github.com/ecdye) this is also becoming the standard Frontail version on [OpenHABian](https://github.com/openhab/openhabian). If you are on the main branch, you can install it using openhabian-config, menu 21.
